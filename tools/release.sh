...
# cannot run, is docs/RELEASE-0.2.3.md. The verifier-facing counterpart, which is
...
Read docs/RELEASE-0.2.3.md before starting. It carries the gate list in full, what
...
cmd_preflight() {
    ...
    for f in docs/VERIFYING.md docs/RELEASE-0.2.3.md docs/PROVISIONING.md docs/KNOWN-ISSUES.md; do
...
cmd_build() {
    ...
    # docs/RELEASE-0.2.3.md and the release notes both state that the shipped image
...
Pushed $TAG. What remains is manual, and in this order:
  ...
  3. Paste the release notes from docs/RELEASE-0.2.3.md, in the order its section
