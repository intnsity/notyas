...
# cannot run, is docs/RELEASE-0.2.2.md. The verifier-facing counterpart, which is
...
KEY_DOCS="docs/VERIFYING.md docs/RELEASE-0.2.2.md docs/SECURITY.md docs/plan-0.2.0/REPRODUCIBLE.md"
...
Read docs/RELEASE-0.2.2.md before starting. It carries the gate list in full, what
...
cmd_preflight() {
    ...
    for f in docs/VERIFYING.md docs/RELEASE-0.2.2.md docs/PROVISIONING.md docs/KNOWN-ISSUES.md; do
...
cmd_build() {
    ...
    # docs/RELEASE-0.2.2.md and the release notes both state that the shipped image
...
Pushed $TAG. What remains is manual, and in this order:
  ...
  3. Paste the release notes from docs/RELEASE-0.2.2.md, in the order its section
     10 gives, including the known limitations in its section 8.
